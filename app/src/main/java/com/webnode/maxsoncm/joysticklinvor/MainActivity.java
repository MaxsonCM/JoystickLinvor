...
/**
 * Created by Maxson on 12/04/2016.
 */
...
//http://wptrafficanalyzer.in/blog/listview-with-images-and-text-using-simple-adapter-in-android/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int[] to = { R.id.imgLayout ,R.id.txtTitulo ,R.id.txtDescri};

        // Instantiating an adapter to store each items
        // R.layout.listview_layout defines the layout of each item
        SimpleAdapter adapter = new SimpleAdapter(getBaseContext(), aList, R.layout.activity_item_layout  , from, to);
